...
export default function TutorCard({ tutor, index }: { tutor: any; index: number }) {
    ...
    return (
        <>
            <div
                className="card-hover rounded-2xl bg-[#141720] p-5 flex items-start gap-5 fade-up relative"
            ...
            >
                {bookingSuccess && (
                    <div className="absolute inset-0 bg-emerald-500/10 backdrop-blur-[2px] z-10 flex items-center justify-center rounded-2xl border border-emerald-500/20">
                        <div className="bg-emerald-500 text-black px-4 py-2 rounded-xl font-bold flex items-center gap-2 scale-up">
                            ✓ Booked!
                        </div>
                    </div>
                )}
